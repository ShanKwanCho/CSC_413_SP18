...
public class Lexer {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            while (true) {
                tok = lex.nextToken();
               // System.out.println("L: " + tok.getLeftPosition() + " R: " + tok.getRightPosition() + " " + tok.toString() + " : " + tok.getLineNumber());          
               
               System.out.printf("%-11s%11s%-6d%11s%-6d%11s%-11s%n",tok.toString(),"Left:",tok.getLeftPosition(),"Right:  ",tok.getRightPosition(), "Line: ",tok.getLineNumber());
            }
        } catch (Exception e) {
     ...
     */
    public Token newNumberToken(int lineNo, String number, int startPosition, int endPosition) {
        return new Token(
                         lineNo,
    ...
    public Token nextToken() {
        ...
        if (Character.isDigit(ch)) {
            ...
            return newNumberToken( LineNumber, number, startPosition, endPosition);
        }
